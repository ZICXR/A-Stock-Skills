...
description: A 股个股技术面分析。当用户需要对某只股票做技术面分析时,Claude 应使用此 Skill。支持 K 线形态识别 (十字星/锤子线/吞没/早晨之星/黄昏之星)、趋势研判 (均线多头/空头/MACD 金叉死叉)、超买超卖 (KDJ/RSI)、支撑压力位 (R1/R2/S1/S2) 计算、综合买卖信号生成 (买入/卖出/观望)。
---
